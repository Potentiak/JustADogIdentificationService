//  THIS PART HAS BEEN COPIED FROM TENSORFLOW APP EXAMPLE AS OF MAKING THIS THERE WAS NO METHOD
//  FOR CONVERTING IMAGE RECEIVED FROM CAMERA INTO A SUITABLE TENSORFLOW IMAGE FOR MY MODEL
